        ...
        const fetchConferences = async () => {
            try {
                ...
                if (subOrganizerRoles.length > 0) {
                    ...
                    const response = await axios.get(`https://bzchair.org/api/conferences?filters[requestStatus][$eq]=approved&filters[AssignedSubOrganizer][id][$eq]=${userId}&populate=*`);
                ...
                const response = await axios.get(`https://bzchair.org/api/conferences?filters[requestStatus][$eq]=approved&filters[Organizer][$eq]=${organizerId}&populate=*`);
    ...
    useEffect(() => {
        ...
        const fetchReviews = async () => {
            ...
            try {
                ...
                const response = await axios.get('https://bzchair.org/api/paper-reviews');
