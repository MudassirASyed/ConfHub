...
const setButtonLoading = (index, action, isLoading) => {
  ...
  useEffect(() => {
    const fetchOrganizers = async () => {
      try {
        ...
        const response = await axios.get('https://bzchair-backend.up.railway.app/api/organizers');
  ...
  const updateRequestStatus = async (id, status) => {
    try {
      ...
      const response = await axios.put('https://bzchair-backend.up.railway.app/api/organizers/update-status', {
