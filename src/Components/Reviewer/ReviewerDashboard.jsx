    ...
    const fetchData = async () => {
      ...
      try {
        const userResponse = await axios.get(
          ...
          `https://bzchair-backend.up.railway.app/api/users/${userId}?populate=reviewerId`
        ...
        const [ongoingRes, completedRes, assignedRes] = await Promise.all([
          ...
          axios.get("https://bzchair-backend.up.railway.app/api/papers?populate=*"),
          axios.get(
            "https://bzchair-backend.up.railway.app/api/papers?populate[review][populate]=reviewer&populate=conference"
          ),
          axios.get(
            `https://bzchair-backend.up.railway.app/api/papers?filters[reviewRequestsConfirmed][id][$eq]=${reviewerId}&populate=*`
