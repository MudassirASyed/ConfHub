/**
 * reviewer-invitation controller
 */
        ...
        <html>
          ...
          <body style="font-family:sans-serif;text-align:center;padding:40px;">
            ...
            <p><a href="http://localhost:5173/login">Go to Login</a></p>
             <p>or if not already registered as reviewer then.<a><a href="http://localhost:5173/register" className="text-blue-600 mt-4 inline-block">
          Go to SignUp
        </a></a></p>
          </body>
        </html>
